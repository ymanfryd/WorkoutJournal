# -*- encoding: utf-8 -*-
# stub: google-cloud-storage 1.61.0 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-storage".freeze
  s.version = "1.61.0".freeze
  ...
  s.add_runtime_dependency(%q<google-apis-core>.freeze, [">= 0.18".freeze, "< 2".freeze])
  s.add_runtime_dependency(%q<google-apis-iamcredentials_v1>.freeze, ["~> 0.18".freeze])
  s.add_runtime_dependency(%q<google-apis-storage_v1>.freeze, [">= 0.42".freeze])
  ...
  s.add_development_dependency(%q<google-style>.freeze, ["~> 1.31.1".freeze])
